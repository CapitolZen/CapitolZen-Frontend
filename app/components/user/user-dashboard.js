...
export default Component.extend({
  ...
  actionsMax: computed('_actionsRaw', function() {
    return getWithDefault(this, '_actionsRaw.length', 0);
  }),
  actionsReviewed: computed('actionList.[]', function() {
    return get(this, 'actionsMax') - get(this, 'actionList.length');
  }),
