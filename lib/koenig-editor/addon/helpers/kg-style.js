...
export function kgStyle(params /*, hash*/) {
  ...
  let cardBorderStyle =
    'pt1 pb1 pl14 nl14 pr2 nr2 ba b--whitegrey br3 relative kg-card-hover';
  ...
  switch (style) {
    ...
    case 'media-card-p':
      cssClass =
        pFontStyle +
        ' nt2 nr2 nl2 pa2 ba b--transparent kg-card-hover tmb--2-0x';
      break;
    case 'media-card-h':
      cssClass =
        pFontStyle +
        ' nt2 nr2 nl2 pa2 ba b--transparent kg-card-hover tmb--3-0x';
      break;
    ...
    case 'media-card-list':
      cssClass =
        pFontStyle +
        ' nt2 nr2 nl2 pa2 ba b--transparent kg-card-hover tmb--1-5x';
      break;
    ...
    case 'figcaption':
      cssClass =
        'db pa2 pb0 mw-s center lh-title sans-serif fw4 f7 middarkgrey tracked-2 tc';
      break;
